...
// First solution
type FirstConcat<T extends List, U extends List> = T extends readonly  [...infer V]
  ? (U extends readonly [...infer W] ? [...V, ...W] : never)
  : never

// After checking answers
type Concat<T extends List, U extends List> = [...T, ...U]
