...
// MyOmitUnion<"foo" | "bar" | "baz", "bar"> = "foo" | baz
type MyOmitUnion<T, ToRemove> = T extends ToRemove ? never : T

type MyOmit<T, ToRemove extends keyof T> = {
  [P in MyOmitUnion<keyof T, ToRemove>]: T[P]
}
